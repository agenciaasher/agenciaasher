...
description: >
  Concepção completa de produto digital: Promessa (5 opções, max 10 palavras, infinitivo),
  50 Benefícios em 5 categorias, 5 Baldes Para Quem É e Identidade do Consumidor com
  5 objeções × 7 argumentos (70 parágrafos). Aprovação bloco a bloco. Gera documento .md
  final. Use quando pedirem conceber produto, criar promessa, definir benefícios, identidade
  do consumidor, ou montar concepção de infoproduto.
---
...
Se a concepção for para um cliente da agência, consulte o briefing em `clientes/<nome>/projeto.md` para usar dados reais. Para a **Agvel Veículos**, a concepção pode ser aplicada a produtos como guia de compra de seminovos, checklist de revisão veicular, ou iscas digitais do funil de leads. Para a **Clincog**, pode ser aplicada ao Clube Clincog (assinatura), cursos gravados, congressos como o Integra, ou ebooks de neuropsicologia. Adapte exemplos, dores e benefícios ao nicho real do cliente.
...
Depois de salvar, mostre o caminho do arquivo e o resumo do pacote entregue.
...
- **Se houver erro ao salvar**, mostre o conteúdo completo do documento no chat para o aluno copiar manualmente.
