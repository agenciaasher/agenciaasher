# Curso Passei — Prof. Ramon Matos

## Dados do Cliente

| Campo | Detalhe |
|-------|---------|
| Nome | Curso Preparatório Passei |
| Diretor / Rosto da marca | Prof. Ramon Matos |
| Segmento | Preparatório para concursos públicos (foco em magistério) |
| Localização | Nova Iguaçu / Queimados — RJ |
| Atuação | Nacional (online) + local (presencial RJ) |
| Fundação | Março/2018 |
| CNPJ | 29.931.449/0001-55 |
| Instagram marca | [@preparatoriopasseiconcursos](https://www.instagram.com/preparatoriopasseiconcursos/) |
...
### O que fazem
Preparatório para concursos públicos com foco em concursos de magistério (professor público municipal e estadual). O Prof. Ramon Matos é o rosto e principal professor de Português — matéria que mais reprova nos concursos públicos.

### Transformação gerada
O aluno passa no concurso público e conquista estabilidade financeira. Para o público de magistério: aprovação no cargo de professor efetivo.

### Números
- +3.000 aprovações
- 27K+ seguidores no Instagram
- Canal YouTube ativo com conteúdo gratuito de Português por banca
...
Professor Ramon Matos domina o português das principais bancas do RJ. Conteúdo gratuito abundante no YouTube cria confiança antes da compra. Aprovações reais e recorrentes validam o método.

### Diferencial principal
**Foco em bancas específicas** — enquanto outros cursos ensinam português genérico, Ramon ensina o português da banca X para o concurso Y. Isso encurta drasticamente o estudo.

### Diferencial de autoridade
- YouTube ativo com resolução de provas por banca (IAN, Consulplan, COSEAC etc.)
- Ramon é professor praticante, não apenas teórico
- Histórico de aprovações documentadas

### Tom de comunicação
Direto, acessível, motivador. "Fala a língua do concurseiro". Sem academicismo excessivo. Incentiva sem criar falsas expectativas.
...
### Nicho
Concursos públicos para magistério — um dos maiores nichos de concursos do Brasil. Prefeituras e estados abrem vagas todo ano para professor I e II.

### Principais concorrentes
| Concorrente | Perfil |
|-------------|--------|
| **Degrau Cultural** | Presencial RJ, tradicional, mais caro |
| **QConcursos / Gran Cursos** | Nacional, digital, alto volume |
| **Estratégia Concursos** | Nacional, digital, ticket médio-alto |
| **Passei Online** (passeionline.com.br) | Nome similar, cuidado com confusão |

### Vantagem do Passei
- Preço acessível vs. grandes plataformas
- Foco local no RJ (bancas regionais que os grandes ignoram)
- Autoridade do Ramon como professor de português específico por banca

---

## Sazonalidade (ver sazonalidade.md)

Concursos públicos têm calendário próprio. Os momentos de maior demanda são:
- Janeiro-Março: editais do início do ano
- Agosto-Outubro: editais de segundo semestre
- Black Friday: campanha de vendas de cursos
- Dias antes do fechamento de inscrição de qualquer concurso relevante

---

## Funil Atual (ver funil.md)

- Topo: YouTube gratuito + Instagram
- Meio: captação de leads (simulado gratuito, aula gratuita)
- Fundo: venda de cursos (site / hotmart)
- Gargalo provável: conversão de seguidores/views em compradores
...
| Métrica | Hoje | Meta |
|---------|------|------|
| Aprovações documentadas | 3.000+ | Aumentar e divulgar |
| Seguidores Instagram | 27K+ | Crescimento + conversão |
| Receita cursos online | A levantar | Escalar |

### O que define sucesso com a agência
Aumentar a conversão do público gratuito (YouTube/Instagram) em compradores. Estruturar funil com produto de entrada barato → upsell para mentoria ou curso completo.

---

## Entregáveis e Checklist

### 01 — Estratégia
- [ ] Diagnóstico do funil atual (YouTube → Instagram → site → venda)
- [ ] Mapeamento da esteira de produtos com gaps e oportunidades
- [ ] Planejamento mensal de campanha por concurso/edital ativo
- [ ] Reunião mensal de resultado

### 02 — Tráfego Pago
- [ ] Gestão de Meta Ads (segmentação por concurso ativo)
- [ ] Campanhas de remarketing para quem assistiu YouTube
- [ ] Relatório mensal de CPL e CPA

### 03 — Copy e Conversão
- [ ] Copy de anúncios por concurso específico
- [ ] Script de atendimento para fechar vendas no WhatsApp/DM
- [ ] Mapa de objeções (preço, tempo, "o concurso vai sair mesmo?")

### 04 — Conteúdo
- [ ] Pauta mensal alinhada com concursos abertos
- [ ] Reels de autoridade com Ramon (resolução de questão, dica de banca)
- [ ] Conteúdo de prova social (aprovações, depoimentos)

---

## Anotações

- Ramon é o ativo principal da marca — qualquer estratégia precisa do rosto dele
- Confusão com "Passei Online" (passeionline.com.br) — evitar na comunicação
- Público muito sensível a "saiu edital" — campanhas devem ser ativadas em horas após publicação de edital
- Ticket baixo atual sugere que o grande volume está no curso gravado — oportunidade em mentoria e assinatura
